...
```
The bar chart shows that members if the LBGTQ community are less likely to contract covid 91 if your received the vaccine.   
...
The Fisher exact test shows the p-value is .0000007269 which is lower than 0.05 so we reject the null hypothesis.
